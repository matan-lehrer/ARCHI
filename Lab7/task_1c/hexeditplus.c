...
int main(int argc, char** argv){
	struct menuItem menu[] = {{"Toggle Debug Mode", changeDebugMode}, {"Set File Name", setFileName}, {"Set Unit Size", setUnitsize},{"Mem Display", memDisplay}, {"Load Into Memory", loadIntoMemory}, {"Save Into File", saveIntoFile}, {"Quit", quit}, {NULL , NULL}};
	char choose[10];
	size = 1;
	int i;
